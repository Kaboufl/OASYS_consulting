    ...
    <dialog id="addClient" class="w-96 h-fit rounded relative overflow-hidden p-8 space-y-4">
        ...
        <form action="" method="POST" class="w-full space-y-4">
            ...
            <label class="inline-block w-full">
                <span class="block mb-2 text-sm font-medium text-gray-900 ">Raison Sociale</span>
                <input type="text" name="raison_sociale" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </label>
            <label class="inline-block w-full">
            ...
            <label class="inline-block w-full">
                ...
                <input type="text" name="ville" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </label>
