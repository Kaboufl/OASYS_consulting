...
<h1 class="text-4xl font-extrabold leading-none leading-10 tracking-tight text-white sm:text-5xl md:text-6xl xl:text-7xl">
    <span class="block">Vous imaginez,</span><span class="block">Nous développons</span>
</h1>
...
<p class="mx-auto mt-3 text-sm text-left text-gray-200 md:text-center md:mt-12 sm:text-base md:max-w-xl md:text-lg xl:text-xl">Il avait l'air de s'être envolé après sa mise en liberté surveillée</p>
@stop