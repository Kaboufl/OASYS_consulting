<nav class="row-start-1 row-span-2 col-start-1 my-4 py-4 px-8 bg-gray-800 rounded-r-md">
    ...
    <ul class="w-full h-fit flex flex-col gap-1">
        ...
        <li>
            <a href="{{ route('admin.projets') }}" class="@if(str_starts_with(Route::currentRouteName(), 'admin.projet')) bg-gray-400 font-bold text-gray-800 @else text-white @endif flex flex-row justify-start gap-4 items-center p-2 px-4 rounded-full hover:bg-gray-600 text-lg transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 ml-0">
        ...
        <li>
            <a href="{{ route('admin.salaries') }}" class="@if(str_contains(Route::currentRouteName(), 'salarie')) bg-gray-400 font-bold text-gray-800 @else text-white @endif flex flex-row justify-start gap-4 items-center p-2 px-4 rounded-full hover:bg-gray-600 text-lg transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 ml-0">
        ...
        <li>
            <a href="{{ route('admin.prestataires') }}" class="@if(str_contains(Route::currentRouteName(), 'prestataires')) bg-gray-400 font-bold text-gray-800 @else text-white @endif flex flex-row justify-start gap-4 items-center p-2 px-4 rounded-full hover:bg-gray-600 text-lg transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 ml-0">
