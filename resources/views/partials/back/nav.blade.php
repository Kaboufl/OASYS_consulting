<nav class="row-start-1 row-span-2 col-start-1 my-4 py-4 px-8 bg-gray-800 rounded-r-md">
    ...
    @if(auth()->user()->admin()->count())
        ...
        <li>
            <a href="{{ route('back.admin.dashboard') }}" class="@if(str_contains(Route::currentRouteName(), 'dashboard')) bg-gray-400 font-bold text-gray-800 @else text-white @endif flex flex-row justify-start gap-4 items-center p-2 px-4 rounded-full hover:bg-gray-600 text-lg transition-all">
